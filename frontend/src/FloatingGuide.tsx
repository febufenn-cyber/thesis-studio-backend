...
const S: Record<string, CSSProperties> = {
  ...
  panel: { position: "absolute", right: 0, bottom: 70, width: 360, maxWidth: "calc(100vw - 36px)", maxHeight: "min(560px, calc(100vh - 120px))", overflowY: "auto", background: "#fff", color: "#1b2733", border: "1px solid #e7e3db", borderRadius: 16, boxShadow: "0 16px 48px rgba(20,25,35,.28)" },
  head: { display: "flex", alignItems: "center", gap: 10, padding: "12px 14px", borderBottom: "1px solid #e7e3db", position: "sticky", top: 0, background: "#fff" },
  title: { fontSize: 14, fontWeight: 800 },
  subtitle: { fontSize: 10.5, color: "#6b7688", letterSpacing: 0.3 },
  close: { width: 30, height: 30, borderRadius: 8, border: "1px solid #e7e3db", background: "#fff", cursor: "pointer", fontSize: 16 },
  body: { padding: "12px 14px" },
  primary: { width: "100%", padding: "11px 14px", borderRadius: 10, border: "1px solid #4b4bd6", background: "#4b4bd6", color: "#fff", fontWeight: 700, fontSize: 13, cursor: "pointer", marginBottom: 12 },
  back: { border: 0, background: "transparent", color: "#4b4bd6", fontWeight: 600, fontSize: 12, cursor: "pointer", padding: 0, marginBottom: 8 },
  tipHead: { fontSize: 11, fontWeight: 800, color: "#6b7688", textTransform: "uppercase", letterSpacing: 0.5, margin: "6px 0 8px" },
  tip: { border: "1px solid #e7e3db", borderRadius: 10, padding: "9px 11px", marginBottom: 8 },
  tipTitle: { fontSize: 12.5, fontWeight: 700, marginBottom: 2 },
  tipBody: { fontSize: 11.5, color: "#6b7688", lineHeight: 1.5 },
  domainBtn: { display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 3, width: "100%", textAlign: "left", border: "1px solid #e7e3db", borderRadius: 10, padding: "10px 12px", background: "#fff", cursor: "pointer", marginBottom: 8, fontFamily: "inherit", fontSize: 13, color: "#1b2733" },
  badge: { display: "inline-block", fontSize: 10.5, fontWeight: 700, color: "#4b4bd6", background: "#ecebfb", borderRadius: 999, padding: "3px 9px", marginBottom: 6 },
  sec: { fontSize: 12, fontWeight: 800, margin: "12px 0 5px" },
  list: { margin: "0 0 4px", paddingLeft: 18, fontSize: 12, lineHeight: 1.6, color: "#1b2733" },
  msg: { fontSize: 12, fontWeight: 600, color: "#1f9d6b", background: "#e5f4ee", borderRadius: 8, padding: "8px 10px" },
};
