...
const S: Record<string, CSSProperties> = {
  ...
  muted: { color: "#6b7688", fontSize: 12.5, margin: "4px 0 10px" },
  rowLine: { display: "flex", alignItems: "center", gap: 9, marginBottom: 8, flexWrap: "wrap" },
  depRow: { display: "flex", alignItems: "center", gap: 9, padding: "7px 0", borderTop: "1px solid #f0ede6", flexWrap: "wrap" },
  chip: { fontSize: 10.5, fontWeight: 700, color: "#6b7688", background: "#eef0f3", borderRadius: 999, padding: "3px 9px", textTransform: "uppercase" },
  chipGood: { color: "#1f9d6b", background: "#e5f4ee" },
  chipBad: { color: "#d64545", background: "#fbe7e7" },
  mono: { fontFamily: "ui-monospace, monospace", fontSize: 12 },
  link: { color: "#4b4bd6", fontSize: 12, fontWeight: 600, textDecoration: "none" },
  input: { flex: 1, minWidth: 180, fontFamily: "inherit", fontSize: 13, border: "1px solid #e7e3db", borderRadius: 8, padding: "8px 10px" },
  btn: { padding: "8px 13px", borderRadius: 8, border: "1px solid #4b4bd6", background: "#4b4bd6", color: "#fff", fontWeight: 600, fontSize: 12.5, cursor: "pointer" },
  btnGhost: { padding: "8px 13px", borderRadius: 8, border: "1px solid #e7e3db", background: "#fff", color: "#1b2733", fontWeight: 600, fontSize: 12.5, cursor: "pointer" },
  err: { color: "#d64545", fontSize: 12.5 },
  hint: { fontSize: 11.5, color: "#6b7688", marginTop: 6 },
};
