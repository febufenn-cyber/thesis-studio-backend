...
const S: Record<string, CSSProperties> = {
  ...
  input: { flex: 1, fontFamily: "inherit", fontSize: 13, border: "1px solid #e7e3db", borderRadius: 8, padding: "8px 10px" },
  ...
  meta: { fontSize: 12, color: "#6b7688", marginTop: 2 },
  rorLink: { fontSize: 11.5, color: "#4b4bd6", fontFamily: "ui-monospace, monospace", textDecoration: "none", display: "inline-block", marginTop: 5 },
