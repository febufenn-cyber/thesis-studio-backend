...
const tab = (active: boolean): CSSProperties => ({
  ...
  color: active ? "#A5B8FF" : "rgba(255,255,255,0.55)",
  fontWeight: 600,
  fontSize: 12.5,
  cursor: "pointer",
});
...
const S: Record<string, CSSProperties> = {
  ...
  input: { flex: 1, fontFamily: "inherit", fontSize: 13, border: "1px solid rgba(255,255,255,0.13)", borderRadius: 8, padding: "8px 10px" },
  ...
  meta: { fontSize: 12, color: "rgba(255,255,255,0.55)", marginTop: 2 },
  rorLink: { fontSize: 11.5, color: "#A5B8FF", fontFamily: "'IBM Plex Mono', ui-monospace, monospace", textDecoration: "none", display: "inline-block", marginTop: 5 },
