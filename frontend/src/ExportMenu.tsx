...
const S: Record<string, CSSProperties> = {
  packCard: { display: "flex", flexWrap: "wrap", alignItems: "center", gap: 12, border: "1px solid #1F4D3A", background: "#E8EFE9", borderRadius: 12, padding: "14px 15px", marginBottom: 16 },
  packTitle: { fontSize: 14.5, fontWeight: 800, color: "#1F4D3A" },
  packDesc: { fontSize: 12, color: "#1C1917", marginTop: 3, maxWidth: 420, lineHeight: 1.5 },
  packBtn: { marginLeft: "auto", padding: "10px 16px", borderRadius: 10, border: "1px solid #1F4D3A", background: "#1F4D3A", color: "#fff", fontWeight: 700, fontSize: 13, cursor: "pointer", whiteSpace: "nowrap" },
  packNote: { width: "100%", fontSize: 11.5, color: "#9A6A00", margin: 0 },
  packOk: { width: "100%", fontSize: 11.5, color: "#1F7A4D", fontWeight: 600, margin: 0 },
  ...
  btn: { padding: "8px 14px", borderRadius: 8, border: "1px solid #1F4D3A", background: "#1F4D3A", color: "#fff", fontWeight: 600, fontSize: 12.5, cursor: "pointer", whiteSpace: "nowrap" },
  hint: { fontSize: 11, color: "#6E655A", marginTop: 8 },
  muted: { color: "#6E655A", fontSize: 12.5 },
  err: { color: "#B3362C", fontSize: 12.5, marginTop: 8 },
  subHead: { fontSize: 11, fontWeight: 700, color: "#6E655A", textTransform: "uppercase", letterSpacing: 0.4, marginBottom: 8 },
  rowWrap: { display: "flex", gap: 8, flexWrap: "wrap" },
  btnGhost: { padding: "7px 12px", borderRadius: 8, border: "1px solid #DCD3C5", background: "#fff", color: "#1C1917", fontWeight: 600, fontSize: 12.5, cursor: "pointer" },
};
