...
const S: Record<string, CSSProperties> = {
  ...
  select: { flex: 1, fontFamily: "inherit", fontSize: 12.5, border: "1px solid #DCD3C5", background: "#fff", borderRadius: 7, padding: "7px 8px" },
  input: { width: "100%", boxSizing: "border-box", fontFamily: "inherit", fontSize: 12.5, border: "1px solid #DCD3C5", borderRadius: 7, padding: "7px 9px", marginBottom: 8 },
  btn: { display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 13px", borderRadius: 9, border: "1px solid #1F4D3A", background: "#1F4D3A", color: "#fff", fontWeight: 600, fontSize: 12.5, cursor: "pointer" },
  err: { color: "#B3362C", fontSize: 12.5, marginTop: 9 },
  out: { marginTop: 12, border: "1px solid #DCD3C5", borderRadius: 11, padding: "12px 14px" },
  outHead: { fontSize: 11, color: "#6E655A", fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.4, marginBottom: 8 },
